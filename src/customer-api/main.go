...
func customersList(w http.ResponseWriter, r *http.Request) {
	...
	listResp := &ListResponse{
		Customers: []*Customer{
			{
				Name:    "Raul Fernandez",
				Address: "Las magnolias 1234",
			},
			{
				Name:    "Aaron Mcferdinan",
				Address: "Elm Street",
			},
		},
	}
...
func main() {
	...
	// Set up a `/customers` resource handler
	http.HandleFunc("/customers", customersList)
	...
	// Create server listening on 8443
